        ...
        <div className='mt-2 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9 hidden md:block' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              ...
              <button
                type='submit'
                className='flex-shrink-0 rounded-sm bg-orange px-6 py-2 transition-all hover:opacity-90'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                      ...
                      <div className='mt-5'>
                        {cart?.slice(0, 5).map((item) => (
                          <div
                            ...
                            className='mt-5 flex cursor-pointer px-3 py-2 hover:bg-gray-100'
                            aria-hidden='true'
                          >
                            ...
                            <div className='ml-2 flex-shrink-0'>
                              <span className='font-bold text-orange'>đ{formatCurrency(item.product.price)}</span>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          >
            <Link to={path.cart} className='relative'>
              ...
              {cart && (
                <span className='absolute left-[17px] top-[-5px] rounded-full bg-white px-3 py-[1px] text-xs font-bold text-orange'>
                  {cart?.length}
                </span>
              )}
            </Link>
