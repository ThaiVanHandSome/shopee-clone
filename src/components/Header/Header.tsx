...
export default function Header() {
  ...
  return (
    <header
      className='pb-5 pt-2 text-white'
      style={{
    ...
    >
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            className='flex items-center py-1 hover:text-gray-300 cursor-pointer me-4'
            renderPopover={
              <div className='flex flex-col py-2 px-3 text-black text-sm'>
        ...
        <div className='grid grid-cols-12 gap-4 mt-2 items-end'>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex'>
              ...
              />
              <button className='rounded-sm py-2 px-6 flex-shrink-0 bg-orange hover:opacity-90 transition-all'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
