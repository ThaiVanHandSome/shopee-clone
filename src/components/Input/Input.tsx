...
export default function Input({
  ...
  if (isPasswordInput) {
    if (canViewPassword) typeInput = 'text'
    else typeInput = 'password'
  }

  const toggleView = () => {
    setCanViewPassword((prev) => !prev)
  }

  return (
    <div className={className}>
      <div className='relative'>
        <input type={typeInput} name={name} {...registerResult} className={classNameInput} {...rest} />
        {isPasswordInput && canViewPassword && (
          <svg
